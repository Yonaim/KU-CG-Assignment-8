...
/* Too hard to get the exit annotations correct for exit in recent Visual Studio
 * compilers (2015 on) */
#if _MSC_VER >= 1900
#include <corecrt.h>
#endif
...
#include <CodeAnalysis\sourceannotations.h>
	extern _CRTIMP __declspec(noreturn) void __cdecl exit([SA_Pre(
		Null
		= SA_No)][SA_Pre(Deref = 1, Valid = SA_Yes, Access = SA_Read)] int);
#else
...
signal handling.
 ...
 GLUT_XLIB_IMPLEMENTATION=17 mjk's GLUT 3.8 with glutStrokeWidthf and
glutStrokeLengthf
**/
...
#define GLUT_CURSOR_FULL_CROSSHAIR 102
	...
	GLUTAPI void GLUTAPIENTRY __glutInitWithExit(int *argcp, char **argv,
...
#endif
#endif
	GLUTAPI int GLUTAPIENTRY  glutCreateSubWindow(int win, int x, int y,
...
#if defined(_WIN32) && !defined(GLUT_DISABLE_ATEXIT_HACK)
	GLUTAPI int GLUTAPIENTRY __glutCreateMenuWithExit(
		void(GLUTCALLBACK *func)(int), void(__cdecl *exitfunc)(int));
#ifndef GLUT_BUILDING_LIB
	static int GLUTAPIENTRY
	glutCreateMenu_ATEXIT_HACK(void(GLUTCALLBACK *func)(int))
	{
...
#define glutCreateMenu glutCreateMenu_ATEXIT_HACK
	...
	GLUTAPI void GLUTAPIENTRY glutMouseFunc(
		void(GLUTCALLBACK *func)(int button, int state, int x, int y));
	GLUTAPI void GLUTAPIENTRY glutMotionFunc(void(GLUTCALLBACK *func)(int x,
																	  int y));
	GLUTAPI void GLUTAPIENTRY
	...
	GLUTAPI void GLUTAPIENTRY glutTabletButtonFunc(
		void(GLUTCALLBACK *func)(int button, int state, int x, int y));
#if (GLUT_API_VERSION >= 3)
	GLUTAPI void GLUTAPIENTRY
	...
	GLUTAPI void GLUTAPIENTRY glutKeyboardUpFunc(
		void(GLUTCALLBACK *func)(unsigned char key, int x, int y));
	GLUTAPI void GLUTAPIENTRY
	glutSpecialUpFunc(void(GLUTCALLBACK *func)(int key, int x, int y));
	GLUTAPI void GLUTAPIENTRY glutJoystickFunc(
	...
	GLUTAPI void GLUTAPIENTRY    glutSetColor(int, GLfloat red, GLfloat green,
											  GLfloat blue);
	...
	GLUTAPI float GLUTAPIENTRY glutStrokeLengthf(void                *font,
												 const unsigned char *string);
#endif

	/* GLUT pre-built models sub-API */
	GLUTAPI void GLUTAPIENTRY glutWireSphere(GLdouble radius, GLint slices,
											 GLint stacks);
	GLUTAPI void GLUTAPIENTRY glutSolidSphere(GLdouble radius, GLint slices,
											  GLint stacks);
	GLUTAPI void GLUTAPIENTRY glutWireCone(GLdouble base, GLdouble height,
										   GLint slices, GLint stacks);
	GLUTAPI void GLUTAPIENTRY glutSolidCone(GLdouble base, GLdouble height,
											GLint slices, GLint stacks);
	...
	GLUTAPI void GLUTAPIENTRY glutWireTorus(GLdouble innerRadius,
											GLdouble outerRadius, GLint sides,
											GLint rings);
	...
	GLUTAPI void GLUTAPIENTRY glutVideoResize(int x, int y, int width,
											  int height);
